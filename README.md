...
📊 Key Findings from Exploratory Data Analysis (EDA)
    ...
    Statistical Verdict: Kruskal-Wallis tests confirmed a highly significant relationship (p<2.2e−16) between delay and scores, though the effect size is small (ϵ2≈0.015), explaining only ~1.5% of score variance.
